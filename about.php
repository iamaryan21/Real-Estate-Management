        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    ...
                    <div class="agent-details">
                        <h5><a href="#">Sherlock Holmes</a></h5>
                    ...
                    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <p class="lead">
                                    I recently sold a house with property hunters and while this can be a very stressful process, I felt 100% confident by partnering with property hunters. They provided great feedback, helped explain clearly all the details and managed the actual sale negotiation brilliantly. In addition, they were extremely responsive to each and every question of mine, no matter how small. As I move forward to now buy my next property, I am extremely certain property hunters will be the right partner to help me accomplish this process.
                                </p>
                                <div class="avatar">
                            ...
                            <div class="carousel-item">
                                <p class="lead">
                                     Nobody knows their business better than property hunters. Glad to be a part of the family.
                                </p>
                                <div class="avatar">
